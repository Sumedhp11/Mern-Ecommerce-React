                  ...
                  <div className="lg:col-span-3">
                    <div className="w-fit">
                      <Link
                        ...
                        className="rounded-md bg-green-600 mx-10 my-5 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                      >
                        Add New Products
                      </Link>
                    </div>
                                  ...
                                  <div className="mt-4 flex justify-between">
                                    <div>
                                      ...
                                      <p className="mt-1 text-left text-sm text-gray-500">
                                        ...
                                        <span className="align-bottom pl-1">
                                          {product.rating}
                                        </span>
                                      </p>
                                    </div>
    ...
    <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
      <div className="flex flex-1 justify-between sm:hidden">
        <div
          ...
          className="relative cursor-pointer inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium  hover:bg-gray-50"
        >
          Previous
        </div>
        <div
